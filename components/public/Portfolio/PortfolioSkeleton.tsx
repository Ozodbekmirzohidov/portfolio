          ...
          <div className="bg-card rounded-2xl border border-border overflow-hidden">
            <div className="px-10 pt-12 pb-10 flex flex-col gap-8">
              <div className="flex flex-col gap-4">
                ...
                <div className="h-6 w-1/2 bg-gray-100 dark:bg-gray-800 rounded-xl animate-pulse" />
              </div>
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <div className="flex items-center justify-between px-5 py-4 gap-4">
                    <div className="flex flex-col gap-2">
                      <div className="h-6 w-40 bg-gray-100 dark:bg-gray-800 rounded-lg" />
                      <div className="h-4 w-28 bg-gray-100 dark:bg-gray-800 rounded-lg" />
                    </div>
                    <div className="flex gap-3">
                      <div className="h-5 w-24 bg-gray-100 dark:bg-gray-800 rounded-lg" />
